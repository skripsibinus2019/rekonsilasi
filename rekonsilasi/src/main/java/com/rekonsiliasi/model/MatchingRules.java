...
public class MatchingRules {
    ...
    private List<MatchingRules> list;
    private String draw;
...
//    "recordsTotal": 1,
    ...
    public List<MatchingRules> getList() {
		return list;
	}

	public void setList(List<MatchingRules> list) {
		this.list = list;
	}
	...
	public MatchingRules(Integer id, String wsId, Integer amount, String transactionDate, Integer status,
			List<MatchingRules> list, String draw, Integer recordsFiltered, Integer recordsTotal, String tableSource,
	...
	public MatchingRules(String wsId, Integer amount, String transactionDate, Integer status, String tableSource,
			String notes_lama, String notes_baru) {
		super();
		this.wsId = wsId;
		this.amount = amount;
    ...
    public MatchingRules(Integer id, String wsId, Integer amount,
